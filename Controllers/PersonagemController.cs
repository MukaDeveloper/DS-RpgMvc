...
namespace RpgMvc.Controllers
{
    ...
    {
        public string uriBase = "http://mukacat.somee.com/RpgApi/Personagens/";
        ...
        public async Task<ActionResult> CreateAsync(PersonagemViewModel p)
        {
            try
            {
                ...
                else throw new System.Exception(serialized);
            }
            catch (System.Exception ex)
            {
                TempData["MensagemErro"] = ex.Message;
        ...
        public async Task<ActionResult> EditAsync(PersonagemViewModel p)
        {
            try
            {
                ...
                {
                    TempData["Mensagem"] =
                        string.Format($"Personagem {p.Nome}, classe {p.Classe} atualizado com sucesso!");
        ...
        public async Task<ActionResult> DisputaGeralAsync()
        {
            try
            {
                ...
                string uriDisputa = "http://mukacat.somee.com/RpgApi/Disputas/DisputaEmGrupo";
